...
const Hero = () => {
  return (
    <div id="hero" className="w-full grid md:grid-cols-2 grid-cols-1 bg-white lg:px-24 px-6 lg:py-20 py-8 "  >
      <div className="text-center md:text-start flex flex-col justify-center items-center md:me-20 " >
